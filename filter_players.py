...
OUTPUT_PATH = "docs/players_2025.jsonl"
...
def filter_players(players: dict) -> list:
    """
    Return a list of dicts with only the fields:
    player_id, full_name, first_name, last_name, position,
    status, years_exp, depth_chart_order, team.
    Includes all 32 DEF teams with consistent formatting.
    """
    filtered = []
